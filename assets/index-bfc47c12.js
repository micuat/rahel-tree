(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();/*! (c) Andrea Giammarchi - ISC */var T={};try{T.WeakMap=WeakMap}catch{T.WeakMap=function(t,s){var n=s.defineProperty,r=s.hasOwnProperty,o=i.prototype;return o.delete=function(l){return this.has(l)&&delete l[this._]},o.get=function(l){return this.has(l)?l[this._]:void 0},o.has=function(l){return r.call(l,this._)},o.set=function(l,a){return n(l,this._,{configurable:!0,value:a}),this},i;function i(l){n(this,"_",{value:"_@ungap/weakmap"+t++}),l&&l.forEach(c,this)}function c(l){this.set(l[0],l[1])}}(Math.random(),Object)}const O=T.WeakMap;/*! (c) Andrea Giammarchi - ISC */var m="-"+Math.random().toFixed(6)+"%",X=!1;try{(function(e,t,s){return t in e&&(e.innerHTML="<p "+s+'="'+m+'"></p>',e[t].childNodes[0].getAttribute(s)==m)})(document.createElement("template"),"content","tabindex")||(m="_dt: "+m.slice(1,-1)+";",X=!0)}catch{}var Z="<!--"+m+"-->",o1=8,c1=1,a1=3,D=/^(?:plaintext|script|style|textarea|title|xmp)$/i,C1=/^(?:area|base|br|col|embed|hr|img|input|keygen|link|menuitem|meta|param|source|track|wbr)$/i;/*! (c) Andrea Giammarchi - ISC */function f1(e){return e.join(Z).replace(v1,m1).replace(u1,h1)}var B=" \\f\\n\\r\\t",W="[^"+B+`\\/>"'=]+`,V="["+B+"]+"+W,Q="<([A-Za-z]+[A-Za-z0-9:._-]*)((?:",Y=`(?:\\s*=\\s*(?:'[^']*?'|"[^"]*?"|<[^>]*?>|`+W.replace("\\/","")+"))?)",u1=new RegExp(Q+V+Y+"+)(["+B+"]*/?>)","g"),v1=new RegExp(Q+V+Y+"*)(["+B+"]*/>)","g"),g1=new RegExp("("+V+`\\s*=\\s*)(['"]?)`+Z+"\\2","gi");function h1(e,t,s,n){return"<"+t+s.replace(g1,p1)+n}function p1(e,t,s){return t+(s||'"')+m+(s||'"')}function m1(e,t,s){return C1.test(t)?e:"<"+t+s+"></"+t+">"}const{isArray:L}=Array,{indexOf:i2,slice:A}=[],j=e=>({get:t=>e.get(t),set:(t,s)=>(e.set(t,s),s)}),w1=1,J=111,d1=({firstChild:e,lastChild:t})=>{const s=document.createRange();return s.setStartAfter(e),s.setEndAfter(t),s.deleteContents(),e},y=(e,t)=>e.nodeType===J?1/t<0?t?d1(e):e.lastChild:t?e.valueOf():e.firstChild:e,x1=e=>{const{childNodes:t}=e,{length:s}=t;if(s<2)return s?t[0]:e;const n=A.call(t,0),r=n[0],o=n[s-1];return{ELEMENT_NODE:w1,nodeType:J,firstChild:r,lastChild:o,valueOf(){if(t.length!==s){let i=0;for(;i<s;)e.appendChild(n[i++])}return e}}};/*! (c) Andrea Giammarchi - ISC */var $=function(e){var t="fragment",s="template",n="content"in i(s),r=n?function(l){var a=i(s);return a.innerHTML=l,a.content}:function(l){var a=i(t),C=i(s),u=null;if(/^[^\S]*?<(col(?:group)?|t(?:head|body|foot|r|d|h))/i.test(l)){var v=RegExp.$1;C.innerHTML="<table>"+l+"</table>",u=C.querySelectorAll(v)}else C.innerHTML=l,u=C.childNodes;return o(a,u),a};return function(a,C){return(C==="svg"?c:r)(a)};function o(l,a){for(var C=a.length;C--;)l.appendChild(a[0])}function i(l){return l===t?e.createDocumentFragment():e.createElementNS("http://www.w3.org/1999/xhtml",l)}function c(l){var a=i(t),C=i("div");return C.innerHTML='<svg xmlns="http://www.w3.org/2000/svg">'+l+"</svg>",o(a,C.firstChild.childNodes),a}}(document);const z=(e,t,s,n,r)=>{const o=s.length;let i=t.length,c=o,l=0,a=0,C=null;for(;l<i||a<c;)if(i===l){const u=c<o?a?n(s[a-1],-0).nextSibling:n(s[c-a],0):r;for(;a<c;)e.insertBefore(n(s[a++],1),u)}else if(c===a)for(;l<i;)(!C||!C.has(t[l]))&&e.removeChild(n(t[l],-1)),l++;else if(t[l]===s[a])l++,a++;else if(t[i-1]===s[c-1])i--,c--;else if(t[l]===s[c-1]&&s[a]===t[i-1]){const u=n(t[--i],-1).nextSibling;e.insertBefore(n(s[a++],1),n(t[l++],-1).nextSibling),e.insertBefore(n(s[--c],1),u),t[i]=s[c]}else{if(!C){C=new Map;let u=a;for(;u<c;)C.set(s[u],u++)}if(C.has(t[l])){const u=C.get(t[l]);if(a<u&&u<c){let v=l,h=1;for(;++v<i&&v<c&&C.get(t[v])===u+h;)h++;if(h>u-a){const g=n(t[l],0);for(;a<u;)e.insertBefore(n(s[a++],1),g)}else e.replaceChild(n(s[a++],1),n(t[l++],-1))}else l++}else e.removeChild(n(t[l++],-1))}return s};/*! (c) Andrea Giammarchi - ISC */var b1=function(e,t,s,n,r){var o=r in e,i=e.createDocumentFragment();i[t](e[n]("g")),i[t](e[n](""));var c=o?e[r](i,!0):i[s](!0);return c.childNodes.length<2?function l(a,C){for(var u=a[s](),v=a.childNodes||[],h=v.length,g=0;C&&g<h;g++)u[t](l(v[g],C));return u}:o?e[r]:function(l,a){return l[s](!!a)}}(document,"appendChild","cloneNode","createTextNode","importNode"),_="".trim||function(){return String(this).replace(/^\s+|\s+/g,"")},M1=X?function(e,t){var s=t.join(" ");return t.slice.call(e,0).sort(function(n,r){return s.indexOf(n.name)<=s.indexOf(r.name)?-1:1})}:function(e,t){return t.slice.call(e,0)};function y1(e,t){for(var s=t.length,n=0;n<s;)e=e.childNodes[t[n++]];return e}function t1(e,t,s,n){for(var r=e.childNodes,o=r.length,i=0;i<o;){var c=r[i];switch(c.nodeType){case c1:var l=n.concat(i);z1(c,t,s,l),t1(c,t,s,l);break;case o1:var a=c.textContent;if(a===m)s.shift(),t.push(D.test(e.nodeName)?I(e,n):A1(c,n.concat(i)));else switch(a.slice(0,2)){case"/*":if(a.slice(-2)!=="*/")break;case"👻":e.removeChild(c),i--,o--}break;case a1:D.test(e.nodeName)&&_.call(c.textContent)===Z&&(s.shift(),t.push(I(e,n)));break}i++}}function z1(e,t,s,n){for(var r=e.attributes,o=[],i=[],c=M1(r,s),l=c.length,a=0;a<l;){var C=c[a++],u=C.value===m,v;if(u||1<(v=C.value.split(Z)).length){var h=C.name;if(o.indexOf(h)<0){o.push(h);var g=s.shift().replace(u?/^(?:|[\S\s]*?\s)(\S+?)\s*=\s*('|")?$/:new RegExp("^(?:|[\\S\\s]*?\\s)("+h+`)\\s*=\\s*('|")[\\S\\s]*`,"i"),"$1"),d=r[g]||r[g.toLowerCase()];if(u)t.push(q(d,n,g,null));else{for(var x=v.length-2;x--;)s.shift();t.push(q(d,n,g,v))}}i.push(C)}}l=i.length,a=0;for(var k=0<l&&X&&!("ownerSVGElement"in e);a<l;){var w=i[a++];k&&(w.value=""),e.removeAttribute(w.name)}var b=e.nodeName;if(/^script$/i.test(b)){var M=document.createElement(b);for(l=r.length,a=0;a<l;)M.setAttributeNode(r[a++].cloneNode(!0));M.textContent=e.textContent,e.parentNode.replaceChild(M,e)}}function A1(e,t){return{type:"any",node:e,path:t}}function q(e,t,s,n){return{type:"attr",node:e,path:t,name:s,sparse:n}}function I(e,t){return{type:"text",node:e,path:t}}var R=j(new O);function E1(e,t){var s=(e.convert||f1)(t),n=e.transform;n&&(s=n(s));var r=$(s,e.type);e1(r);var o=[];return t1(r,o,t.slice(0),[]),{content:r,updates:function(i){for(var c=[],l=o.length,a=0,C=0;a<l;){var u=o[a++],v=y1(i,u.path);switch(u.type){case"any":c.push({fn:e.any(v,[]),sparse:!1});break;case"attr":var h=u.sparse,g=e.attribute(v,u.name,u.node);h===null?c.push({fn:g,sparse:!1}):(C+=h.length-2,c.push({fn:g,sparse:!0,values:h}));break;case"text":c.push({fn:e.text(v),sparse:!1}),v.textContent="";break}}return l+=C,function(){var d=arguments.length;if(l!==d-1)throw new Error(d-1+" values instead of "+l+`
`+t.join("${value}"));for(var x=1,k=1;x<d;){var w=c[x-k];if(w.sparse){var b=w.values,M=b[0],S=1,P=b.length;for(k+=P-2;S<P;)M+=arguments[x++]+b[S++];w.fn(M)}else w.fn(arguments[x++])}return i}}}}function k1(e,t){var s=R.get(t)||R.set(t,E1(e,t));return s.updates(b1.call(document,s.content,!0))}var L1=[];function H1(e){var t=L1,s=e1;return function(n){return t!==n&&(s=k1(e,t=n)),s.apply(null,arguments)}}function e1(e){for(var t=e.childNodes,s=t.length;s--;){var n=t[s];n.nodeType!==1&&_.call(n.textContent).length===0&&e.removeChild(n)}}/*! (c) Andrea Giammarchi - ISC */var Z1=function(){var e=/acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i,t=/([^A-Z])([A-Z]+)/g;return function(c,l){return"ownerSVGElement"in c?n(c,l):o(c.style,!1)};function s(i,c,l){return c+"-"+l.toLowerCase()}function n(i,c){var l;return c?l=c.cloneNode(!0):(i.setAttribute("style","--hyper:style;"),l=i.getAttributeNode("style")),l.value="",i.setAttributeNode(l),o(l,!0)}function r(i){var c,l=[];for(c in i)l.push(c.replace(t,s),":",i[c],";");return l.join("")}function o(i,c){var l,a;return function(C){var u,v,h,g;switch(typeof C){case"object":if(C){if(l==="object"){if(!c&&a!==C)for(v in a)v in C||(i[v]="")}else c?i.value="":i.cssText="";u=c?{}:i;for(v in C)g=C[v],h=typeof g=="number"&&!e.test(v)?g+"px":g,!c&&/^--/.test(v)?u.setProperty(v,h):u[v]=h;l="object",c?i.value=r(a=u):a=C;break}default:a!=C&&(l="string",a=C,c?i.value=C||"":i.cssText=C||"");break}}}}();const B1=e=>t=>{for(const s in t){const n=s==="role"?s:`aria-${s}`,r=t[s];r==null?e.removeAttribute(n):e.setAttribute(n,r)}},G=(e,t)=>{let s,n=!0;const r=document.createAttributeNS(null,t);return o=>{s!==o&&(s=o,s==null?n||(e.removeAttributeNode(r),n=!0):(r.value=o,n&&(e.setAttributeNodeNS(r),n=!1)))}},N1=(e,t,s)=>n=>{s!==!!n&&((s=!!n)?e.setAttribute(t,""):e.removeAttribute(t))},s1=({dataset:e})=>t=>{for(const s in t){const n=t[s];n==null?delete e[s]:e[s]=n}},T1=(e,t)=>{let s,n=t.slice(2);return!(t in e)&&t.toLowerCase()in e&&(n=n.toLowerCase()),r=>{const o=L(r)?r:[r,!1];s!==o[0]&&(s&&e.removeEventListener(n,s,o[1]),(s=o[0])&&e.addEventListener(n,s,o[1]))}},O1=e=>t=>{typeof t=="function"?t(e):t.current=e},U=(e,t)=>t==="dataset"?s1(e):s=>{e[t]=s},X1=(e,t)=>{let s;return n=>{s!==n&&(s=n,e[t]!==n&&(n==null?(e[t]="",e.removeAttribute(t)):e[t]=n))}},V1=/^(?:form|list)$/i,j1=(e,t)=>e.ownerDocument.createTextNode(t);function n1(e){return this.type=e,H1(this)}n1.prototype={attribute(e,t,s){const n=this.type==="svg";switch(t){case"class":if(n)return G(e,t);t="className";case"props":return U(e,t);case"aria":return B1(e);case"style":return Z1(e,s,n);case"ref":return O1(e);case".dataset":return s1(e);default:return t.slice(0,1)==="."?U(e,t.slice(1)):t.slice(0,1)==="?"?N1(e,t.slice(1)):t.slice(0,2)==="on"?T1(e,t):t in e&&!(n||V1.test(t))?X1(e,t):G(e,t)}},any(e,t){const{type:s}=this;let n=!1,r;const o=i=>{switch(typeof i){case"string":case"number":case"boolean":n?r!==i&&(r=i,t[0].textContent=i):(n=!0,r=i,t=z(e.parentNode,t,[j1(e,i)],y,e));break;case"function":o(i(e));break;case"object":case"undefined":if(i==null){n=!1,t=z(e.parentNode,t,[],y,e);break}default:if(n=!1,r=i,L(i))if(i.length===0)t.length&&(t=z(e.parentNode,t,[],y,e));else switch(typeof i[0]){case"string":case"number":case"boolean":o(String(i));break;case"function":o(i.map(S1,e));break;case"object":L(i[0])&&(i=i.concat.apply([],i));default:t=z(e.parentNode,t,i,y,e);break}else"ELEMENT_NODE"in i?t=z(e.parentNode,t,i.nodeType===11?A.call(i.childNodes):[i],y,e):"text"in i?o(String(i.text)):"any"in i?o(i.any):"html"in i?t=z(e.parentNode,t,A.call($([].concat(i.html).join(""),s).childNodes),y,e):"length"in i&&o(A.call(i));break}};return o},text(e){let t;const s=n=>{if(t!==n){t=n;const r=typeof n;r==="object"&&n?"text"in n?s(String(n.text)):"any"in n?s(n.any):"html"in n?s([].concat(n.html).join("")):"length"in n&&s(A.call(n).join("")):r==="function"?s(n(e)):e.textContent=n??""}};return s}};function S1(e){return e(this)}const{create:P1,freeze:D1,keys:r2}=Object,F=j(new O),q1=e=>({html:K("html",e),svg:K("svg",e),render(t,s){const n=typeof s=="function"?s():s,r=F.get(t)||F.set(t,E()),o=n instanceof N?H(e,r,n):n;return o!==r.wire&&(r.wire=o,t.textContent="",t.appendChild(o.valueOf())),t}}),E=()=>({stack:[],entry:null,wire:null}),K=(e,t)=>{const s=j(new O),n=o=>function(){return H(t,o,r.apply(null,arguments))};return r.for=(o,i)=>{const c=s.get(o)||s.set(o,P1(null));return c[i]||(c[i]=n(E()))},r.node=function(){return H(t,E(),r.apply(null,arguments)).valueOf()},r;function r(){return new N(e,R1.apply(null,arguments))}},H=(e,t,{type:s,template:n,values:r})=>{const{length:o}=r;i1(e,t,r,o);let{entry:i}=t;if(!i||i.template!==n||i.type!==s){const c=new e(s);t.entry=i={type:s,template:n,tag:c,wire:x1(c(n,...r))}}else i.tag(n,...r);return i.wire},i1=(e,{stack:t},s,n)=>{for(let r=0;r<n;r++){const o=s[r];o instanceof I1?s[r]=H(e,t[r]||(t[r]=E()),o):L(o)?i1(e,t[r]||(t[r]=E()),o,o.length):t[r]=null}n<t.length&&t.splice(n)};D1(N);function N(e,t){this.type=e,this.template=t.shift(),this.values=t}const I1=N,{render:r1,html:f,svg:l2}=q1(n1);function R1(){let e=[],t=0,{length:s}=arguments;for(;t<s;)e.push(arguments[t++]);return e}const G1="Rahel Vard",U1="Assistant",F1="Rahel Vard",K1="custom-theme",W1="https://cdn.glitch.global/623b23e8-3916-4148-9c08-4b8954556605/bioto.png?v=1696362411004",l1=[{url:"mailto:rahel.vard@gmail.com",text:"Email (Rahel)",img:"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>📨</text></svg>"},{url:"https://www.youtube.com/c/NaotoHieda",text:"Naoto YouTube",img:"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>📺</text></svg>"},{url:"https://naotohieda.com/",text:"Naoto's homepage",img:"data:image/png;base64,",altText:"Glitch blue generative art"},{url:"https://naoto-portfolio.glitch.me/",text:"Naoto artist portfolio",img:"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>🌈</text></svg>"},{url:"https://glitches.me/",text:"Workshops",img:"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>🧪</text></svg>"},{url:"https://naotohieda.com/cv",text:"Naoto's CV",img:"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>⏳</text></svg>"},{url:"mailto:mail@naotohieda.com",text:"Email (Naoto)",img:"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>📨</text></svg>"}],Q1=[{url:"https://best-practices.glitch.me/",text:"Best Practices in Contemporary Dance with Jorge",img:"https://cdn.glitch.global/bc1a4c77-fc26-4223-b92e-c4a103cabc10/favicon-32-bp.png?v=1694636479789"},{url:"https://soup.glitches.me/",text:"soup.glitches.me",img:"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>🍲</text></svg>"},{url:"https://heartbreak-cards.glitch.me/",text:"24 Hour Heartbreak Cards",img:"https://cdn.glitch.global/61984d65-52b6-418b-b420-2547b4acca3d/favicon-32.png?v=1694627304921"},{url:"https://nail.glitches.me/",text:"Naoto's Nail Salon",img:"https://cdn.glitch.global/f010c3f2-aa1e-49b9-8912-c199b98aeb28/favicon-32-nail.png?v=1694637566730"},{url:"https://naotohieda.glitch.me/",text:"#NaotoHieda",img:"https://naotohieda.com/img/favicon-32-nh.png"},{url:"https://festival.naotohieda.com/",text:"Naoto's Festival",img:"https://cdn.glitch.global/ba681ad3-9dce-4551-832f-7877f5305b26/favicon-32-festival.png?v=1694634659660"},{url:"https://riso.glitches.me/",text:"riso.glitches.me",img:"https://naotohieda.com/img/favicon-32-riso.png"},{url:"https://3d.glitches.me/",text:"GlitchMe with Flor",img:"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>🤖</text></svg>"},{url:"https://openprocessing.org/user/104460/",text:"OpenProcessing",img:"https://openprocessing.org/assets/img/logo/favicons/favicon-32x32.png"},{url:"https://note.com/naoto_hieda",text:"note (Japanese)",img:"https://assets.st-note.com/poc-image/manual/note-common-images/production/icons/apple-touch-icon-60x60.png"},{url:"https://glitches.me/",text:"glitches.me",img:"data:image/png;base64,"}],Y1={glitch:"https://glitch.com/@n.hieda",arena:"",bandcamp:"",cohost:"",dev:"",facebook:"",github:"https://github.com/micuat",gitlab:"",hashnode:"",instagram:"",keybase:"",kofi:"",letterboxd:"",linkedin:"",mastodon:"",medium:"",onlyfans:"",patreon:"",pinboard:"",pinterest:"",podcast:"",soundcloud:"",spotify:"",stackoverflow:"",substack:"",twitter:"",twitch:"",tiktok:"",tumblr:"",youtube:"https://www.youtube.com/c/NaotoHieda",email:"mail@naotohieda.com"},p={metaTitle:G1,metaDescription:U1,name:F1,theme:K1,avatarImage:W1,links:l1,backuplinks:Q1,social:Y1},J1=f.node`
...
`,$1=()=>f`<div>
  ...
  <h1>${p.name}</h1>
  <h2>${p.metaDescription}</h2>
</div>`;function _1(e){const t=e.url?e.url.replace(/[^a-z0-9]/gi,"-").toLowerCase():"";return f`
    <li class=${t}>
  ...
  `}const t2=({keyword:e=""})=>f`
    <ul class="link-list">
      ${l1.filter(t=>{var s;return(s=t==null?void 0:t.text)==null?void 0:s.toLowerCase().includes(e.toLowerCase())}).map(_1)}
    </ul>
  `;f`<svg
...
C213.484,200.108,212.476,198.418,210.857,197.545z"
  ...
  >
    <path
      ...
      fill="black"
    />
  </svg>`;const e2=document.getElementsByTagName("head")[0];e2.appendChild(J1);const s2=document.querySelector(".content-header");document.querySelector(".content-input");const n2=document.querySelector(".content-links");document.querySelector(".content-socials");document.querySelector(".content-footer");r1(s2,$1());r1(n2,t2({keyword:""}));
